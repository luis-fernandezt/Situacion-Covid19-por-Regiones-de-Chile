...
producto4 <- read_csv("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto4/2021-06-25-CasosConfirmados-totalRegional.csv")
...
ggx1 <- annotate_figure(ggx,
                        top = text_grob("SituaciÛn por regiones\n25 de junio de 2021", #cambiar fecha manualmente
