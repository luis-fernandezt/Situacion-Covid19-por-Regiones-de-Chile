...
producto4 <- read_csv("https://raw.githubusercontent.com/MinCiencia/Datos-COVID19/master/output/producto4/2021-05-07-CasosConfirmados-totalRegional.csv")
...
ggx1 <- annotate_figure(ggx,
                        top = text_grob("SituaciÛn por regiones\n07 de mayo de 2021", #cambiar fecha manualmente
